...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const endpoint =
        userType === 'employee' ? `${API_BASE}/api/auth/login` : `${API_BASE}/api/auth/customer-login`
          ...
          {!userType ? (
            <div className="user-type-selection">
              ...
              <div className="button-group">
                <button type="button" className="user-type-btn employee-btn" onClick={() => setUserType('employee')}>
                  👔 Employee
                </button>
                <button type="button" className="user-type-btn customer-btn" onClick={() => setUserType('customer')}>
                  👤 Customer
                </button>
              </div>
            </div>
            ...
            <>
              <form onSubmit={handleSubmit}>
                ...
                <button type="button" className="back-button-top" onClick={resetForm}>
                  ← Back
                </button>
            ...
            <>
              <form onSubmit={handleForgotPassword}>
                <button type="button" className="back-button-top" onClick={() => setShowForgotPassword(false)}>
                  ← Back
                </button>
