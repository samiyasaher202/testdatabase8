  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/packages" element={<p>My Packages — coming soon</p>} />
        ...
        <Route path="/store" element={<p>Store — coming soon</p>} />
        ...
        <Route path="/profile" element={<p>Profile — coming soon</p>} />
